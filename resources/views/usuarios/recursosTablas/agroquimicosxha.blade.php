...
<hr>
<table id="tablaAgroquimicosXHa" class="table table-bordered table-condensed table-striped ">
    <thead>
        <tr>
...
<br />
<br />
<h4>Promedio de agroquímicos por hectarea</h4>
<hr>
<table id="tablaAgroquimicosPromedioXHa" class="table table-bordered table-condensed table-striped ">
    <thead>
        <tr>
...
$(document).ready(
    function() {
        ...
        // Si existe una instancia condatatable la eliminamos para poder reiniciarla
        $('#tablaAgroquimicosPromedioXHa').dataTable().fnDestroy();

        tablaAgroquimicosPromedioXHa = $('#tablaAgroquimicosPromedioXHa').DataTable({
            'iDisplayLength': 25,
            language: {
                "decimal": "",
                "emptyTable": "No hay información",
