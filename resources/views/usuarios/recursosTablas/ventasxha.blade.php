...
<hr>
<table id="tablaVentasXHa" class="table table-bordered table-condensed table-striped">
    <thead>
        <tr>
...
<br />
<br />
<h4>Promedio de ventas por hectarea</h4>
<hr>
<table id="tablaVentasPromedioXHa" class="table table-bordered table-condensed table-striped">
    <thead>
        <tr>
...
$(document).ready(
    function() {
        ...
        $('#tablaVentasXHa').dataTable().fnDestroy();
        ...
        // Si existe una instancia condatatable la eliminamos para poder reiniciarla
        $('#tablaVentasPromedioXHa').dataTable().fnDestroy();

        tablaVentasPromedioXHa = $('#tablaVentasPromedioXHa').DataTable({
            'iDisplayLength': 25,
            language: {
                "decimal": "",
                "emptyTable": "No hay información",
