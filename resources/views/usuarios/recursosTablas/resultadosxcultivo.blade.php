...
<hr>
<table id="tablaResultadosXCultivo" class="table table-bordered table-condensed table-striped">
    <thead>
        <tr>
...
<br />
<br />
<h4>Promedio de resultado por cultivo</h4>
<hr>
<table id="tablaResultadosPromedioXCultivo" class="table table-bordered table-condensed table-striped">
    <thead>
        <tr>
...
$(document).ready(
    function() {
        ...
        // Si existe una instancia condatatable la eliminamos para poder reiniciarla
        $('#tablaResultadosPromedioXCultivo').dataTable().fnDestroy();

        tablaResultadosPromedioXCultivo = $('#tablaResultadosPromedioXCultivo').DataTable({
            'iDisplayLength': 25,
            language: {
                "decimal": "",
                "emptyTable": "No hay información",
