...
<hr>
<table id="tablaCostoXHa" class="table table-bordered table-condensed table-striped col-8">
    <thead>
        <tr>
...
<br />
<br />
<h4>Costo promedio por hectarea</h4>
<hr>
<table id="tablaCostoPromedioXHa" class="table table-bordered table-condensed table-striped col-8">
    <thead>
        <tr>
...
$(document).ready(
    function() {
        ...
        // Si existe una instancia condatatable la eliminamos para poder reiniciarla
        $('#tablaCostoPromedioXHa').dataTable().fnDestroy();

        tablaCostoPromedioXHa = $('#tablaCostoPromedioXHa').DataTable({
            'iDisplayLength': 25,
            language: {
                "decimal": "",
                "emptyTable": "No hay información",
